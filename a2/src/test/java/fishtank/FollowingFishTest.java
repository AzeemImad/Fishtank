...
public class FollowingFishTest {
  ...
  @Test
  public void twoStepsFromFollower(){
    int differenceInX;
    int differenceInY;
    //it should take exactly 15 updates to get from
    //(20, 20) to (5, 10)
    ...
    differenceInX = follower.getX()-followee.getX();
    differenceInY = follower.getY()-followee.getY();

    assertEquals(0,differenceInX);
    assertEquals(2, differenceInY);
  }
}
